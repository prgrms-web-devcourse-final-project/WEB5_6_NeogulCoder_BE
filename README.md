...
<img width="1440" height="800" alt="위비" src="https://github.com/user-attachments/assets/0f32b5c6-cc57-438c-aa74-c47990b547f5" />

<br/>

## 💡 프로젝트 소개

Wibby는 스터디 모집부터 운영·종료까지 **스터디 운영 전반을 지원하는 서비스**입니다. <br>
단순한 스터디 모집을 넘어 **운영·협업·성과 관리**까지 Wibby에서 해결할 수 있습니다. <br>
실시간 소통, 일정 관리, 자기 PR 매칭을 통해 **자율적이면서도 효율적인 스터디 문화**를 만들어갑니다.
...
<img width="2000" height="1414" alt="시스템 아키텍처" src="https://github.com/user-attachments/assets/946235d8-040b-4301-ad95-e0081b795f4e" />

<br>

# ☁️ ERD
<img width="2781" height="1562" alt="WEB5_6_NeogulCoder_BE (1)" src="https://github.com/user-attachments/assets/ec7b16be-6432-4952-862d-93546a87c69c" />
...
### [ 회원 ]
- 이메일 인증 및 소셜 로그인
- 회원가입 시 기본 PR 템플릿 자동 생성

### [ 마이페이지 ]
- 회원 정보 조회 및 수정, 탈퇴
- 내가 참여한 스터디 / 신청한 스터디 / 작성한 모집글 조회
- 개인 캘린더 관리
- PR 템플릿 관리

### [ PR 템플릿 ]
- 자기소개 / 지역 / URL 등 프로필 관리
- 버디에너지 및 리뷰 확인
