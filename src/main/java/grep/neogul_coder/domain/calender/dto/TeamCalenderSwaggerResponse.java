...
public class TeamCalenderSwaggerResponse {
    ...
    public TeamCalenderSwaggerResponse(Long scheduleId, Long teamId, String title, String description, LocalDateTime startTime, LocalDateTime endTime) {
    ...
    // (전체 조회용 생성자)
    public TeamCalenderSwaggerResponse(Long scheduleId, Long teamId, String title, LocalDateTime startTime, LocalDateTime endTime) {
        this.scheduleId = scheduleId;
        this.teamId = teamId;
        this.title = title;
        this.startTime = startTime;
