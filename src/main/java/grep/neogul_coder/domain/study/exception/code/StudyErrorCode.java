...
public enum StudyErrorCode implements ErrorCode {
    ...
    STUDY_EXTENSION_NOT_AVAILABLE("S006", HttpStatus.BAD_REQUEST, "스터디 연장은 스터디 종료일 7일 전부터 가능합니다."),
    END_DATE_BEFORE_ORIGIN_STUDY("S007", HttpStatus.BAD_REQUEST, "연장 스터디 종료일은 기존 스터디 종료일 이후여야 합니다."),
    ALREADY_EXTENDED_STUDY("S008", HttpStatus.BAD_REQUEST, "이미 연장된 스터디입니다."),

    NOT_STUDY_LEADER("S009", HttpStatus.FORBIDDEN, "스터디장만 접근이 가능합니다."),
    LEADER_CANNOT_LEAVE_STUDY("S010", HttpStatus.BAD_REQUEST, "스터디장은 스터디를 탈퇴할 수 없습니다."),
    LEADER_CANNOT_DELEGATE_TO_SELF("S011", HttpStatus.BAD_REQUEST, "자기 자신에게는 스터디장 위임이 불가능합니다.");
