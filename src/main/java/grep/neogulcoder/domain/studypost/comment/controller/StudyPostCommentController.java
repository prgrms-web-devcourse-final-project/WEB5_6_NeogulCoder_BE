...
public class StudyPostCommentController implements StudyPostCommentSpecification {
    ...
    public ResponseEntity<ApiResponse<Long>> create(@PathVariable("post-id") long postId,
    ...
    public ResponseEntity<ApiResponse<Void>> update(@PathVariable("comment-id") long commentId,
    ...
    public ResponseEntity<ApiResponse<Void>> delete(@PathVariable("comment-id") long commentId,
                                    @AuthenticationPrincipal Principal userDetails) {
